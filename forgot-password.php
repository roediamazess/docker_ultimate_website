...
// Function untuk convert local time ke UTC
function convertLocalToUTC($local_time, $timezone = 'Asia/Jakarta') {
    $local = new DateTime($local_time, new DateTimeZone($timezone));
