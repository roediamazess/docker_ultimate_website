        ...
        <div class="login-card">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-input" placeholder="Masukkan email Anda" required autocomplete="username">
                    <iconify-icon icon="solar:letter-outline" class="input-icon"></iconify-icon>
                </div>

                <div class="form-group">
                    <label class="form-label">Password</label>
                    <input type="password" name="password" class="form-input" placeholder="Masukkan password Anda" required autocomplete="current-password">
            ...
            <div style="margin-top: 32px; text-align: center;">
                <p style="color: #666; font-size: 14px;">
                    <a href="#" onclick="alert('Forgot password feature will be available soon! 🔧')" style="color: #667eea; text-decoration: none;">Forgot Password? Click here</a>
                </p>
            </div>
        </div>
    </div>
